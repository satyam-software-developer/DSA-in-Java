...
// Main class definition for PrintIthNode
public class PrintIthNode {
    ...
    static class Node<T> {
        ...
        // Constructor to initialize data and next to null
        public Node(T data) {
            this.data = data;
            next = null;
        }
    ...
    static class Runner {
        ...
        public static Node<Integer> takeInput() throws IOException {
            ...
            while (i < datas.length && !datas[i].equals("-1")) {
                ...
                Node<Integer> newNode = new Node<Integer>(data); // Create a new node with the integer data
        ...
        // Method to print the ith node of the linked list
        public static void printIthNode(Node<Integer> head, int i) {
            int position = 0; // Initialize position counter to 0

            Node<Integer> temp = head; // Create a temporary node pointer and initialize it to head
            // Loop through the linked list until the ith node or end of list is reached
    ...
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        int t = Integer.parseInt(runner.br.readLine().trim()); // Read the number of test cases

        // Loop through each test case
        while (t > 0) {
            Node<Integer> head = runner.takeInput(); // Take input and create a linked list
            int i = Integer.parseInt(runner.br.readLine().trim()); // Read the value of i for ith node
            runner.printIthNode(head, i); // Print the ith node of the linked list
