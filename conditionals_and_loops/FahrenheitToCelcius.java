...
public class FahrenheitToCelcius {
    public static void main(String[] args) {
        ...
        int S = s.nextInt(); // Read the starting Fahrenheit temperature from the user
        int E = s.nextInt(); // Read the ending Fahrenheit temperature from the user
        int W = s.nextInt(); // Read the step size from the user
        int cel; // Variable to store the Celsius temperature

        // Iterate from the starting temperature to the ending temperature with the
        // given step size
        while (S <= E) {
            // Convert Fahrenheit to Celsius using the formula: (5 * (F - 32)) / 9
            cel = ((5 * (S - 32)) / 9);
            // Print the Fahrenheit and corresponding Celsius temperature
            System.out.println(S + " " + cel);
            S += W; // Increment the Fahrenheit temperature by the step size
        }
